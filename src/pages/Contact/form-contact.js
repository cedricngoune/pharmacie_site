      ...
      <form className="w-full max-w-lg" onSubmit={handleSubmit(sendMail)}>
        <div className="mx-3 mb-6">
          <div className="group-element">
            <label htmlFor="fullname" className="text-black-600 font-medium">
              Nom et prénom:
            </label>
            <input
              {...register("fullname", {
          ...
          <div className="group-element">
            <label htmlFor="phone" className="text-black-600 font-medium">
              N°téléphone:
            </label>
            <input
              {...register("phone", {
            ...
            {errors?.phone?.type === "required" && (
              <p className="mb-3 text-normal text-red-500">
                <BiErrorCircle className="inline mr-1" />
                Veuillez entrer votre n° de téléphone
              </p>
            )}
          ...
          <div className="group-element">
            <label htmlFor="email" className="text-black-600 font-medium">
              Email:
            </label>
            <input
              {...register("email", {
          ...
          <div className="group-element">
            <label htmlFor="message" className="text-black-600 font-medium">
              Votre message:
            </label>
            <textarea
              {...register("message", {
          ...
          <button
            type="submit"
            className="mt-4 w-full bg-sky-500/100 hover:bg-lime-700 text-white border py-3 px-6 font-semibold text-md rounded"
          >
            Envoyer
          </button>
        </div>
